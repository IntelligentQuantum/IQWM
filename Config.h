...
static Key keys[] =
{
	...
	{ MODKEY|ShiftMask,		                    XK_minus,	            spawn,		                SHCMD("pamixer --allow-boost -d 15; kill -44 $(pidof IQ-BLOCKS)") },
	{ MODKEY,			                        XK_equal,	            spawn,		                SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof IQ-BLOCKS)") },
	{ MODKEY|ShiftMask,		                    XK_equal,	            spawn,		                SHCMD("pamixer --allow-boost -i 15; kill -44 $(pidof IQ-BLOCKS)") },
	...
	{ MODKEY,			                        XK_e,		            spawn,		                SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 IQ-BLOCKS; rmdir ~/.abook") },
	...
	{ MODKEY,			                        XK_d,		            spawn,                      SHCMD("IQ-MENU-Run") },
	...
	{ MODKEY|ShiftMask,		                    XK_n,		            spawn,		                SHCMD(TERMINAL " -e newsboat; pkill -RTMIN+6 IQ-BLOCKS") },
	{ MODKEY,			                        XK_m,		            spawn,		                SHCMD(TERMINAL " -e ncmpcpp") },
	{ MODKEY|ShiftMask,		                    XK_m,		            spawn,		                SHCMD("pamixer -t; kill -44 $(pidof IQ-BLOCKS)") },
	...
	{ 0,                                        XF86XK_Mail,		    spawn,		                SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 IQ-BLOCKS") },
